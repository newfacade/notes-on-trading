...
from .compute_output import process_input, format_result
    ...
    try:        
        ...
        with create_tempdir():
            ...
            with swallow_io():
                ...
                f_result, f_assertion = format_result(result=result, assertion=assertion)
                queue.put((f_result, f_assertion, None))
        
    except TypeError as e:
        if "'NoneType' object is not callable" in str(e):
            queue.put((None, None, f"Error: Attempted to call a disabled function. Specific error: {e}"))
        else:
            queue.put((None, None, str(e)))
...
def execute_function(
    ...
    p = ctx.Process(
        ...
        args=(queue, code, entry_point, params, assertion)
    )
